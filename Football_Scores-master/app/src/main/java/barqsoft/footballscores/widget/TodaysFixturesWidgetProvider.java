...
public class TodaysFixturesWidgetProvider extends AppWidgetProvider {
    ...
    public static String SCORES_MATCH_ID = "barqsoft.footballscores.widget.todaysfixtureswidget.MATCH_ID";
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int appWidgetId : appWidgetIds) {
            ...
            RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.todays_fixtures);
