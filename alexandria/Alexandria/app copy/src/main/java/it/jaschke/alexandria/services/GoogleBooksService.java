...
/**
 * A IntentService subclass for handling asynchronous task requests in a service on a separate
 *  handler thread that will fetch the book details from the google books api and insert/delete
